...
<h4 class="card-title mt-2">Teacher Sign up</h4>
		@if (session('success'))
...
<div class="border-top card-body text-center">Have an account? <a href="{{url('/teacher')}}">Log In</a></div>
</div>
</div>
</div> 
<script>
