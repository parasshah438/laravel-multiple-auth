...
<header class="card-header">
	<h4 class="card-title mt-2">Student Sign up</h4>
	 				@if (session('success'))
...
<div class="border-top card-body text-center">Have an account? <a href="{{url('/student')}}">Log In</a></div>
</div>
</div>
</div> 
<script>
