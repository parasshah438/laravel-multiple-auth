                    ...
                    <form method="POST" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if(Auth::user()->image == "")
                                <img src="{{ asset('public/noimage.png') }}" class="avatar" alt="Avatar" width=60px>
                                @else 
                                <img src="{{ asset('public/student_profile/'.Auth::user()->image) }}" class="avatar" alt="Avatar" width=60px>
                                @endif 
